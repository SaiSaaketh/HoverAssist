...
__all__ = [ 'FONTITALIC', 'OLE_CANCELBOOL', 'Font',
           'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_PIXELS', 'IFontDisp',
           'Checked', 'OLE_TRISTATE', 'IFont', 'OLE_YSIZE_PIXELS',
           'Color', 'OLE_YPOS_PIXELS', 'OLE_OPTEXCLUSIVE', 'Default',
           'IFontEventsDisp', 'FontEvents', 'VgaColor', 'OLE_COLOR',
           'Unchecked', 'OLE_XPOS_CONTAINER', 'OLE_XSIZE_CONTAINER',
           'FONTNAME', 'OLE_YSIZE_HIMETRIC', 'OLE_HANDLE',
           'OLE_YPOS_HIMETRIC', 'StdPicture', 'LoadPictureConstants',
           'OLE_XPOS_PIXELS', 'FONTSIZE', 'OLE_YPOS_CONTAINER',
           'OLE_YSIZE_CONTAINER', 'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD',
           'Monochrome', 'IPicture', 'OLE_XSIZE_HIMETRIC', 'Gray',
           'StdFont', 'IPictureDisp', 'FONTUNDERSCORE', 'Picture',
           'FONTSTRIKETHROUGH']
from comtypes import _check_version; _check_version('1.1.10', 1575709663.649906)
